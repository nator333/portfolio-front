            ...
            <div class="column is-one-third">
              <div class="card project-card">
                ...
                <div class="card-content">
                  <div class="media">
                    <div class="media-content">
                      ...
                      <p class="subtitle is-6 has-text-grey-light">{{ project.tech }}</p>
                    </div>
                  </div>
                ...
                <footer class="card-footer">
                  @if (project.liveUrl) {
                    <a [href]="project.liveUrl" target="_blank" class="card-footer-item has-text-primary">
                      Live Demo
                    </a>
                  }
                  @if (project.githubUrl) {
                    <a [href]="project.githubUrl" target="_blank" class="card-footer-item has-text-primary">
                      GitHub
                    </a>
                  }
                </footer>
